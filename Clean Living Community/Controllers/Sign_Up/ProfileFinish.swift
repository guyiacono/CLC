...
//
//  Created by Michael Karolewicz on 5/30/18.
...
class ProfileFinish: UIViewController,UIPickerViewDelegate,UIPickerViewDataSource, UITextFieldDelegate
{
    ...
    */
    ...
    {
        if(smokeField.isEditing || supportField.isEditing)
        {
        ...
        else if(eduField.isEditing || relationField.isEditing || spiritualField.isEditing || religiousField.isEditing || orientationField.isEditing)
        {
